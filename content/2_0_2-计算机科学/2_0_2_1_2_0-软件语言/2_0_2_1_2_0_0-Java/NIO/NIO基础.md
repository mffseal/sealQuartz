...
> select方法底层调用的是操作系统的[[2_0_2-计算机科学/2_0_2_1_2_3-软件系统/2_0_2_1_2_3_1-操作系统/epoll|epoll]] 中epoll_wait接口，读取有状态的IO的阻塞方法，可设置超时。
...
> 事件发生后，要么处理，要么取消（cancel），不能什么都不做，否则下次该事件仍会触发，这是因为 nio 底层使用的是[[2_0_2-计算机科学/2_0_2_1_2_3-软件系统/2_0_2_1_2_3_1-操作系统/epoll#水平触发|水平触发]]
...
解决方法：
让register和select在同一个线程中执行方便控制先后顺序 --> 将选择器注册动作交给子线程执行 --> 需要将动作传递给子线程 --> 用[[2_0_2-计算机科学/2_0_2_1_2_0-软件语言/2_0_2_1_2_0_0-Java/2_0_2_1_2_0_0_2-并发编程/线程通讯|线程通讯]]：
